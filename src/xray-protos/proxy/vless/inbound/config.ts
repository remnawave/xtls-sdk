...
export const Config: MessageFns<Config, "xray.proxy.vless.inbound.Config"> = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      secondsFrom: isSet(object.secondsFrom)
        ? globalThis.Number(object.secondsFrom)
        : isSet(object.seconds_from)
        ? globalThis.Number(object.seconds_from)
        : 0,
      secondsTo: isSet(object.secondsTo)
        ? globalThis.Number(object.secondsTo)
        : isSet(object.seconds_to)
        ? globalThis.Number(object.seconds_to)
        : 0,
