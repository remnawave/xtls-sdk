  ...
  fromJSON(object: any): DNSRuleConfig {
    return {
      ...
      qType: globalThis.Array.isArray(object?.qType)
        ? object.qType.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.q_type)
        ? object.q_type.map((e: any) => globalThis.Number(e))
        : [],
...
export const Config: MessageFns<Config, "xray.proxy.dns.Config"> = {
  ...
  encode(message: Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rewriteServer !== undefined) {
      Endpoint.encode(message.rewriteServer, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.rewriteServer = Endpoint.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      rewriteServer: isSet(object.rewriteServer)
        ? Endpoint.fromJSON(object.rewriteServer)
        : isSet(object.rewrite_server)
        ? Endpoint.fromJSON(object.rewrite_server)
        : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    if (message.rewriteServer !== undefined) {
      obj.rewriteServer = Endpoint.toJSON(message.rewriteServer);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Config>): Config {
    ...
    message.rewriteServer = (object.rewriteServer !== undefined && object.rewriteServer !== null)
      ? Endpoint.fromPartial(object.rewriteServer)
      : undefined;
    return message;
  },
};
