...
export const Config: MessageFns<Config, "xray.proxy.dokodemo.Config"> = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      portMap: isObject(object.portMap)
        ? Object.entries(object.portMap).reduce<{ [key: string]: string }>((acc, [key, value]) => {
  ...
  fromPartial(object: DeepPartial<Config>): Config {
    ...
    message.portMap = Object.entries(object.portMap ?? {}).reduce<{ [key: string]: string }>((acc, [key, value]) => {
      if (value !== undefined) {
