  ...
  fromJSON(object: any): ServerConfig {
    return {
      ...
      authType: isSet(object.authType)
        ? authTypeFromJSON(object.authType)
        : isSet(object.auth_type)
        ? authTypeFromJSON(object.auth_type)
        : 0,
      ...
      udpEnabled: isSet(object.udpEnabled)
        ? globalThis.Boolean(object.udpEnabled)
        : isSet(object.udp_enabled)
        ? globalThis.Boolean(object.udp_enabled)
        : false,
