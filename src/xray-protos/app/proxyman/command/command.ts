...
export const HandlerServiceDefinition = {
  ...
  methods: {
    addInbound: {
      name: "AddInbound",
      requestType: AddInboundRequest as typeof AddInboundRequest,
      requestStream: false,
      responseType: AddInboundResponse as typeof AddInboundResponse,
      responseStream: false,
      options: {},
    },
    removeInbound: {
      name: "RemoveInbound",
      requestType: RemoveInboundRequest as typeof RemoveInboundRequest,
      requestStream: false,
      responseType: RemoveInboundResponse as typeof RemoveInboundResponse,
      responseStream: false,
      options: {},
    },
    alterInbound: {
      name: "AlterInbound",
      requestType: AlterInboundRequest as typeof AlterInboundRequest,
      requestStream: false,
      responseType: AlterInboundResponse as typeof AlterInboundResponse,
      responseStream: false,
      options: {},
    },
    listInbounds: {
      name: "ListInbounds",
      requestType: ListInboundsRequest as typeof ListInboundsRequest,
      requestStream: false,
      responseType: ListInboundsResponse as typeof ListInboundsResponse,
      responseStream: false,
      options: {},
    },
    getInboundUsers: {
      name: "GetInboundUsers",
      requestType: GetInboundUserRequest as typeof GetInboundUserRequest,
      requestStream: false,
      responseType: GetInboundUserResponse as typeof GetInboundUserResponse,
      responseStream: false,
      options: {},
    },
    getInboundUsersCount: {
      ...
      requestType: GetInboundUserRequest as typeof GetInboundUserRequest,
      requestStream: false,
      responseType: GetInboundUsersCountResponse as typeof GetInboundUsersCountResponse,
      responseStream: false,
      options: {},
    },
    addOutbound: {
      name: "AddOutbound",
      requestType: AddOutboundRequest as typeof AddOutboundRequest,
      requestStream: false,
      responseType: AddOutboundResponse as typeof AddOutboundResponse,
      responseStream: false,
      options: {},
    },
    removeOutbound: {
      name: "RemoveOutbound",
      requestType: RemoveOutboundRequest as typeof RemoveOutboundRequest,
      requestStream: false,
      responseType: RemoveOutboundResponse as typeof RemoveOutboundResponse,
      responseStream: false,
      options: {},
    },
    alterOutbound: {
      name: "AlterOutbound",
      requestType: AlterOutboundRequest as typeof AlterOutboundRequest,
      requestStream: false,
      responseType: AlterOutboundResponse as typeof AlterOutboundResponse,
      responseStream: false,
      options: {},
    },
    listOutbounds: {
      name: "ListOutbounds",
      requestType: ListOutboundsRequest as typeof ListOutboundsRequest,
      requestStream: false,
      responseType: ListOutboundsResponse as typeof ListOutboundsResponse,
      responseStream: false,
      options: {},
    },
  },
