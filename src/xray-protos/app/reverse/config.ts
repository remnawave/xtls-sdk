  ...
  fromJSON(object: any): Config {
    return {
      ...
      bridgeConfig: globalThis.Array.isArray(object?.bridgeConfig)
        ...
        : globalThis.Array.isArray(object?.bridge_config)
        ? object.bridge_config.map((e: any) => BridgeConfig.fromJSON(e))
        : [],
      portalConfig: globalThis.Array.isArray(object?.portalConfig)
        ? object.portalConfig.map((e: any) => PortalConfig.fromJSON(e))
        : globalThis.Array.isArray(object?.portal_config)
        ? object.portal_config.map((e: any) => PortalConfig.fromJSON(e))
        : [],
    };
  },
