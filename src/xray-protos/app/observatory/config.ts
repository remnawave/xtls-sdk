  ...
  fromJSON(object: any): OutboundStatus {
    return {
      ...
      lastErrorReason: isSet(object.lastErrorReason)
        ...
        : isSet(object.last_error_reason)
        ? globalThis.String(object.last_error_reason)
        : "",
      outboundTag: isSet(object.outboundTag)
        ? globalThis.String(object.outboundTag)
        : isSet(object.outbound_tag)
        ? globalThis.String(object.outbound_tag)
        : "",
      lastSeenTime: isSet(object.lastSeenTime)
        ? globalThis.Number(object.lastSeenTime)
        : isSet(object.last_seen_time)
        ? globalThis.Number(object.last_seen_time)
        : 0,
      lastTryTime: isSet(object.lastTryTime)
        ? globalThis.Number(object.lastTryTime)
        : isSet(object.last_try_time)
        ? globalThis.Number(object.last_try_time)
        : 0,
      healthPing: isSet(object.healthPing)
        ? HealthPingMeasurementResult.fromJSON(object.healthPing)
        : isSet(object.health_ping)
        ? HealthPingMeasurementResult.fromJSON(object.health_ping)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): Intensity {
    return {
      ...
      probeInterval: isSet(object.probeInterval)
        ...
        : isSet(object.probe_interval)
        ? globalThis.Number(object.probe_interval)
        : 0,
    };
  },
  ...
  fromJSON(object: any): Config {
    return {
      ...
      subjectSelector: globalThis.Array.isArray(object?.subjectSelector)
        ...
        : globalThis.Array.isArray(object?.subject_selector)
        ? object.subject_selector.map((e: any) => globalThis.String(e))
        : [],
      probeUrl: isSet(object.probeUrl)
        ? globalThis.String(object.probeUrl)
        : isSet(object.probe_url)
        ? globalThis.String(object.probe_url)
        : "",
      probeInterval: isSet(object.probeInterval)
        ? globalThis.Number(object.probeInterval)
        : isSet(object.probe_interval)
      ...
      enableConcurrency: isSet(object.enableConcurrency)
        ...
        : isSet(object.enable_concurrency)
        ? globalThis.Boolean(object.enable_concurrency)
        : false,
    };
  },
