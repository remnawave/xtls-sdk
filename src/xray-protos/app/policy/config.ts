  ...
  fromJSON(object: any): Policy_Timeout {
    return {
      ...
      connectionIdle: isSet(object.connectionIdle)
        ...
        : isSet(object.connection_idle)
        ? Second.fromJSON(object.connection_idle)
        : undefined,
      uplinkOnly: isSet(object.uplinkOnly)
        ? Second.fromJSON(object.uplinkOnly)
        : isSet(object.uplink_only)
        ? Second.fromJSON(object.uplink_only)
        : undefined,
      downlinkOnly: isSet(object.downlinkOnly)
        ? Second.fromJSON(object.downlinkOnly)
        : isSet(object.downlink_only)
        ? Second.fromJSON(object.downlink_only)
        : undefined,
    };
  },
...
export const Policy_Stats: MessageFns<Policy_Stats, "xray.app.policy.Policy.Stats"> = {
  ...
  fromJSON(object: any): Policy_Stats {
    return {
      ...
      userUplink: isSet(object.userUplink)
        ? globalThis.Boolean(object.userUplink)
        : isSet(object.user_uplink)
        ? globalThis.Boolean(object.user_uplink)
        : false,
      userDownlink: isSet(object.userDownlink)
        ? globalThis.Boolean(object.userDownlink)
        : isSet(object.user_downlink)
        ? globalThis.Boolean(object.user_downlink)
        : false,
      userOnline: isSet(object.userOnline)
        ? globalThis.Boolean(object.userOnline)
        : isSet(object.user_online)
        ? globalThis.Boolean(object.user_online)
        : false,
    };
  },
  ...
  fromJSON(object: any): SystemPolicy_Stats {
    return {
      ...
      inboundUplink: isSet(object.inboundUplink)
        ...
        : isSet(object.inbound_uplink)
        ? globalThis.Boolean(object.inbound_uplink)
        : false,
      inboundDownlink: isSet(object.inboundDownlink)
        ? globalThis.Boolean(object.inboundDownlink)
        : isSet(object.inbound_downlink)
        ? globalThis.Boolean(object.inbound_downlink)
        : false,
      outboundUplink: isSet(object.outboundUplink)
        ? globalThis.Boolean(object.outboundUplink)
        : isSet(object.outbound_uplink)
        ? globalThis.Boolean(object.outbound_uplink)
        : false,
      outboundDownlink: isSet(object.outboundDownlink)
        ? globalThis.Boolean(object.outboundDownlink)
        : isSet(object.outbound_downlink)
        ? globalThis.Boolean(object.outbound_downlink)
        : false,
    };
  },
