...
export const TransportConfig: MessageFns<TransportConfig, "xray.transport.internet.TransportConfig"> = {
  ...
  fromJSON(object: any): TransportConfig {
    return {
      ...
      protocolName: isSet(object.protocolName)
        ? globalThis.String(object.protocolName)
        : isSet(object.protocol_name)
        ? globalThis.String(object.protocol_name)
        : "",
...
export const StreamConfig: MessageFns<StreamConfig, "xray.transport.internet.StreamConfig"> = {
  ...
  encode(message: StreamConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.udpmasks) {
      TypedMessage.encode(v!, writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.udpmasks.push(TypedMessage.decode(reader, reader.uint32()));
          continue;
        }
        case 11: {
          if (tag !== 90) {
  ...
  fromJSON(object: any): StreamConfig {
    return {
      ...
      transportSettings: globalThis.Array.isArray(object?.transportSettings)
        ...
        : globalThis.Array.isArray(object?.transport_settings)
        ? object.transport_settings.map((e: any) => TransportConfig.fromJSON(e))
        : [],
      securityType: isSet(object.securityType)
        ? globalThis.String(object.securityType)
        : isSet(object.security_type)
        ? globalThis.String(object.security_type)
        : "",
      securitySettings: globalThis.Array.isArray(object?.securitySettings)
        ...
        : globalThis.Array.isArray(object?.security_settings)
        ? object.security_settings.map((e: any) => TypedMessage.fromJSON(e))
        : [],
      udpmasks: globalThis.Array.isArray(object?.udpmasks)
        ? object.udpmasks.map((e: any) => TypedMessage.fromJSON(e))
        : [],
      ...
      socketSettings: isSet(object.socketSettings)
        ...
        ? SocketConfig.fromJSON(object.socket_settings)
        : undefined,
    };
  },
  ...
  toJSON(message: StreamConfig): unknown {
    ...
    if (message.udpmasks?.length) {
      obj.udpmasks = message.udpmasks.map((e) => TypedMessage.toJSON(e));
    }
  ...
  fromJSON(object: any): SocketConfig {
    return {
      ...
      acceptProxyProtocol: isSet(object.acceptProxyProtocol)
        ...
        ? globalThis.Boolean(object.accept_proxy_protocol)
        : false,
      domainStrategy: isSet(object.domainStrategy)
        ...
        : 0,
      dialerProxy: isSet(object.dialerProxy)
        ? globalThis.String(object.dialerProxy)
        : isSet(object.dialer_proxy)
        ? globalThis.String(object.dialer_proxy)
        : "",
      tcpKeepAliveInterval: isSet(object.tcpKeepAliveInterval)
        ? globalThis.Number(object.tcpKeepAliveInterval)
        : isSet(object.tcp_keep_alive_interval)
        ? globalThis.Number(object.tcp_keep_alive_interval)
        : 0,
      tcpKeepAliveIdle: isSet(object.tcpKeepAliveIdle)
        ? globalThis.Number(object.tcpKeepAliveIdle)
        : isSet(object.tcp_keep_alive_idle)
        ? globalThis.Number(object.tcp_keep_alive_idle)
        : 0,
      tcpCongestion: isSet(object.tcpCongestion)
        ? globalThis.String(object.tcpCongestion)
        : isSet(object.tcp_congestion)
        ? globalThis.String(object.tcp_congestion)
        : "",
      ...
      tcpWindowClamp: isSet(object.tcpWindowClamp)
        ...
        : isSet(object.tcp_window_clamp)
        ? globalThis.Number(object.tcp_window_clamp)
        : 0,
      tcpUserTimeout: isSet(object.tcpUserTimeout)
        ? globalThis.Number(object.tcpUserTimeout)
        : isSet(object.tcp_user_timeout)
        ? globalThis.Number(object.tcp_user_timeout)
        : 0,
      tcpMaxSeg: isSet(object.tcpMaxSeg)
        ? globalThis.Number(object.tcpMaxSeg)
        : isSet(object.tcp_max_seg)
        ? globalThis.Number(object.tcp_max_seg)
        : 0,
      penetrate: isSet(object.penetrate) ? globalThis.Boolean(object.penetrate) : false,
      tcpMptcp: isSet(object.tcpMptcp)
        ? globalThis.Boolean(object.tcpMptcp)
        : isSet(object.tcp_mptcp)
        ? globalThis.Boolean(object.tcp_mptcp)
        : false,
      ...
      addressPortStrategy: isSet(object.addressPortStrategy)
        ...
        : isSet(object.address_port_strategy)
        ? addressPortStrategyFromJSON(object.address_port_strategy)
        : 0,
      happyEyeballs: isSet(object.happyEyeballs)
        ? HappyEyeballsConfig.fromJSON(object.happyEyeballs)
        : isSet(object.happy_eyeballs)
        ? HappyEyeballsConfig.fromJSON(object.happy_eyeballs)
        : undefined,
      trustedXForwardedFor: globalThis.Array.isArray(object?.trustedXForwardedFor)
        ? object.trustedXForwardedFor.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.trusted_x_forwarded_for)
        ? object.trusted_x_forwarded_for.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const HappyEyeballsConfig: MessageFns<HappyEyeballsConfig, "xray.transport.internet.HappyEyeballsConfig"> = {
  ...
  fromJSON(object: any): HappyEyeballsConfig {
    return {
      ...
      prioritizeIpv6: isSet(object.prioritizeIpv6)
        ? globalThis.Boolean(object.prioritizeIpv6)
        : isSet(object.prioritize_ipv6)
        ? globalThis.Boolean(object.prioritize_ipv6)
        : false,
      interleave: isSet(object.interleave) ? globalThis.Number(object.interleave) : 0,
      tryDelayMs: isSet(object.tryDelayMs)
        ? globalThis.Number(object.tryDelayMs)
        : isSet(object.try_delayMs)
        ? globalThis.Number(object.try_delayMs)
        : 0,
      maxConcurrentTry: isSet(object.maxConcurrentTry)
        ? globalThis.Number(object.maxConcurrentTry)
        : isSet(object.max_concurrent_try)
        ? globalThis.Number(object.max_concurrent_try)
        : 0,
    };
  },
