  ...
  fromJSON(object: any): Config {
    return {
      ...
      minClientVer: isSet(object.minClientVer)
        ...
        : isSet(object.min_client_ver)
        ? bytesFromBase64(object.min_client_ver)
        : new Uint8Array(0),
      maxClientVer: isSet(object.maxClientVer)
        ? bytesFromBase64(object.maxClientVer)
        : isSet(object.max_client_ver)
        ? bytesFromBase64(object.max_client_ver)
        : new Uint8Array(0),
      maxTimeDiff: isSet(object.maxTimeDiff)
        ? globalThis.Number(object.maxTimeDiff)
        : isSet(object.max_time_diff)
        ? globalThis.Number(object.max_time_diff)
        : 0,
      shortIds: globalThis.Array.isArray(object?.shortIds)
        ? object.shortIds.map((e: any) => bytesFromBase64(e))
        : globalThis.Array.isArray(object?.short_ids)
        ? object.short_ids.map((e: any) => bytesFromBase64(e))
        : [],
      mldsa65Seed: isSet(object.mldsa65Seed)
        ? bytesFromBase64(object.mldsa65Seed)
        : isSet(object.mldsa65_seed)
        ? bytesFromBase64(object.mldsa65_seed)
        : new Uint8Array(0),
      limitFallbackUpload: isSet(object.limitFallbackUpload)
        ? LimitFallback.fromJSON(object.limitFallbackUpload)
        : isSet(object.limit_fallback_upload)
        ? LimitFallback.fromJSON(object.limit_fallback_upload)
        : undefined,
      limitFallbackDownload: isSet(object.limitFallbackDownload)
        ? LimitFallback.fromJSON(object.limitFallbackDownload)
        : isSet(object.limit_fallback_download)
        ? LimitFallback.fromJSON(object.limit_fallback_download)
        : undefined,
      ...
      shortId: isSet(object.shortId)
        ? bytesFromBase64(object.shortId)
        : isSet(object.short_id)
        ? bytesFromBase64(object.short_id)
        : new Uint8Array(0),
      mldsa65Verify: isSet(object.mldsa65Verify)
        ? bytesFromBase64(object.mldsa65Verify)
        : isSet(object.mldsa65_verify)
        ? bytesFromBase64(object.mldsa65_verify)
        : new Uint8Array(0),
      spiderX: isSet(object.spiderX)
        ? globalThis.String(object.spiderX)
        : isSet(object.spider_x)
        ? globalThis.String(object.spider_x)
        : "",
      spiderY: globalThis.Array.isArray(object?.spiderY)
        ? object.spiderY.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.spider_y)
        ? object.spider_y.map((e: any) => globalThis.Number(e))
        : [],
...
export const LimitFallback: MessageFns<LimitFallback, "xray.transport.internet.reality.LimitFallback"> = {
  ...
  fromJSON(object: any): LimitFallback {
    return {
      ...
      afterBytes: isSet(object.afterBytes)
        ? globalThis.Number(object.afterBytes)
        : isSet(object.after_bytes)
        ? globalThis.Number(object.after_bytes)
        : 0,
      bytesPerSec: isSet(object.bytesPerSec)
        ? globalThis.Number(object.bytesPerSec)
        : isSet(object.bytes_per_sec)
        ? globalThis.Number(object.bytes_per_sec)
        : 0,
      burstBytesPerSec: isSet(object.burstBytesPerSec)
        ? globalThis.Number(object.burstBytesPerSec)
        : isSet(object.burst_bytes_per_sec)
        ? globalThis.Number(object.burst_bytes_per_sec)
        : 0,
    };
  },
