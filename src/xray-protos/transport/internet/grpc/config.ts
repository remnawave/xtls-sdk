  ...
  fromJSON(object: any): Config {
    return {
      ...
      serviceName: isSet(object.serviceName)
        ...
        : "",
      multiMode: isSet(object.multiMode)
        ? globalThis.Boolean(object.multiMode)
        : isSet(object.multi_mode)
        ? globalThis.Boolean(object.multi_mode)
        : false,
      idleTimeout: isSet(object.idleTimeout)
        ? globalThis.Number(object.idleTimeout)
        : isSet(object.idle_timeout)
        ? globalThis.Number(object.idle_timeout)
        : 0,
      healthCheckTimeout: isSet(object.healthCheckTimeout)
        ? globalThis.Number(object.healthCheckTimeout)
        : isSet(object.health_check_timeout)
        ? globalThis.Number(object.health_check_timeout)
        : 0,
      permitWithoutStream: isSet(object.permitWithoutStream)
        ? globalThis.Boolean(object.permitWithoutStream)
        : isSet(object.permit_without_stream)
        ? globalThis.Boolean(object.permit_without_stream)
        : false,
      initialWindowsSize: isSet(object.initialWindowsSize)
        ? globalThis.Number(object.initialWindowsSize)
        : isSet(object.initial_windows_size)
        ? globalThis.Number(object.initial_windows_size)
        : 0,
